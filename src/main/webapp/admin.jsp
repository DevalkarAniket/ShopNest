...
<head>
<meta charset="UTF-8">
<title>ShopNest:Admin home</title>
...
<body>
	...
	List prodList = DataFetcher.fetchProdInfo();
	%>
	<div class="panel">
				...
				<form action="addProd" method="post">
					<div class="form-group">
						<label for="product-id">Product ID:</label> <input type="text"
							id="product-id" name="pid" required>
					</div>
					<br> <br>
					<div class="form-group">
						<label for="product-name">Product Name:</label> <input type="text"
							id="product-name" name="pname" required>
					</div>
					<br> <br>
					<div class="form-group">
						<label for="product-description">Product Description:</label>
						<textarea id="product-description" name="pdesc" required></textarea>
					</div>
					<br> <br>
					<div class="form-group">
						<label for="product-price">Product Price:</label> <input
							type="text" id="product-price" name="pprice" required>
					</div>
					<br> <br>
					<div class="form-group">
						<label for="product-image">Product Image file name:</label> <input
							type="text" id="product-image" name="pimg" required>
					</div>
					<br> <br>
